...
parser.add_argument('--wip', type=float, default=0.001, help="weight base loss")
# Cudnn
...
parser.add_argument('--num_samples', default=12375, type=int, help='number of samples')#训练样本数目
...
def main():
    ...
    model = Models.define_model(mod=args.mod, max_depth=100)
