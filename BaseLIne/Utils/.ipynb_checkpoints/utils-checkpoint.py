    ...
    if args.lr_policy == 'lambda':
        ...
        class WarmupLR(lr_scheduler._LRScheduler):
            ...
            def get_lr(self):
                ...
                elif self.last_epoch >= self.warmup_steps and self.last_epoch < self.warmup_steps + 4:
                    return [base_lr for base_lr in self.base_lrs]
                else:
                    return [base_lr * math.exp(-(self.last_epoch - self.warmup_steps - 3 ) * 0.2) for base_lr in self.base_lrs]
        
        scheduler = WarmupLR(optimizer, warmup_steps=1)    
